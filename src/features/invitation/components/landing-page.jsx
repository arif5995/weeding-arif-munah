    ...
    return (
      <PhoneFrame>
        <motion.div
          ...
          className={cn("min-h-screen relative overflow-hidden")}
        >
          <div className={cn("flex items-center justify-center h-screen text-center px-4")}>
            ...
            <h2 className={cn("text-2xl font-semibold text-gray-800 mb-2")}>{t("landing.errorTitle")}</h2>
  ...
  if (!invitation) {
    return (
      <PhoneFrame>
        ...
        >
          <div className={cn("flex items-center justify-center h-screen text-center px-4")}>
            <h2 className={cn("text-2xl font-semibold text-gray-800 mb-2")}>{t("landing.notFound")}</h2>
