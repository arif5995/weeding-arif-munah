...
const CornerDecoration = ({ position, variant = "flower-leaf", customOffset = {} }) => {
    ...
    const positionClasses = {
        ...
        "bottom-right": "bottom-0 right-0 flex-row-reverse scale-x-[-1] scale-y-[-1]",
    };
        ...
        >
            ...
            {(variant === "leaf" || variant === "flower-leaf") && (
                <img
                    ...
                    alt=""
                    className={cn(variant === "flower-leaf" ? "w-[60%]" : "w-full", "h-auto")}
                    loading="lazy"
                />
            )}
